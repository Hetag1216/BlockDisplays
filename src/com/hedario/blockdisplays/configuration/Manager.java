...
public class Manager {
	...
	private void loadConfig(ConfigType type) {
		...
		config.addDefault("Commands.Version.Description", "&7Shows plugin's version and information.");
		
		config.addDefault("Commands.Create.Description", "&7Creates a block at the player's standing position.");
		config.addDefault("Commands.Create.OnCreate", "&7Succesfully created &3%name%&b.");
		config.addDefault("Commands.Create.AlreadyExists", "&7A block with the name of &3%name%&b already exists.");
		...
		config.addDefault("Commands.Delete.Description", "&7Deletes an existing block.");
		...
		config.addDefault("Commands.List.Description", "&7Shows a list of existing blocks.");
		config.addDefault("Commands.List.NotFound", "&7There currently aren't any existing blocks.");
		
		config.addDefault("Commands.Info.Description", "&7Shows details about an existing block.");
		...
		config.addDefault("Commands.Edit.Description", "&7Edits the existing block depending on the given variable.");
		...
		config.addDefault("Commands.Edit.OnWrongArgument", "&7The provided argument '&3%argument%&b' is either wrong or invalid.");
		config.addDefault("Commands.Edit.Location.OnEdit", "&7Succesfully edited &3%coord% &bby &3%value%&b for &3%name%&b.");
		config.addDefault("Commands.Edit.Rotate.OnEdit", "&7The block was succesfully rotated of &3%value%&b degree(s).");
		config.addDefault("Commands.Edit.Settings.OnEdit.AutomaticRotation.Status", "&7Automatic rotation has been set to &3%value%&b for &3%name%&b.");
		config.addDefault("Commands.Edit.Settings.OnEdit.AutomaticRotation.Interval", "&7Automatic rotation interval has been set to &3%value%&bms for &3%name%&b.");
		config.addDefault("Commands.Edit.Settings.OnEdit.AutomaticRotation.Degrees", "&7Automatic rotation degree(s) have been set to &3%value%&b for &3%name%&b.");
		...
		config.addDefault("Commands.Teleport.Description", "&7Teleports an existing block to player's position.");
		...
		config.addDefault("Commands.Reload.Description", "&7Reloads plugin's configurations.");
